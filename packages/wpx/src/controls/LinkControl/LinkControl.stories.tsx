...
const Display = (props: { attributes: LinkControlProps['attributes'], children: React.ReactNode }) => {
    return (
        <div>
            <div>
                {props.children}
...
export const Default: Story = {
    render: () => {
        const [attributes, setAttributes] = useState<LinkControlProps['attributes']>({} as LinkControlProps['attributes']);
        return (
