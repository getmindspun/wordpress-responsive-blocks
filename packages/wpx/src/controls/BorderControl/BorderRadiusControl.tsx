...
function calculateIsMixed(attributes: BlockCSSProperties, isResponsive: boolean, deviceType: string) {
    if (isResponsive) {
        switch (deviceType) {
            case 'Tablet':
                return (attributes.tabletBorderTopRightRadius !== attributes.tabletBorderBottomRightRadius) ||
                    (attributes.tabletBorderTopRightRadius !== attributes.tabletBorderBottomLeftRadius) ||
                    (attributes.tabletBorderTopRightRadius !== attributes.tabletBorderTopLeftRadius);
            case 'Mobile':
                return (attributes.mobileBorderTopRightRadius !== attributes.mobileBorderBottomRightRadius) ||
                    (attributes.mobileBorderTopRightRadius !== attributes.mobileBorderBottomLeftRadius) ||
                    (attributes.mobileBorderTopRightRadius !== attributes.mobileBorderTopLeftRadius);
        }
    }
    return !areAllBorderRadiiEqual(attributes);
}

function showClear(attributes: BlockCSSProperties, isResponsive: boolean, deviceType: string) {
    if (isResponsive) {
        switch (deviceType) {
            case 'Tablet':
                return (attributes.tabletBorderTopRightRadius !== undefined ||
            ...
            case 'Mobile':
                return (attributes.mobileBorderTopRightRadius !== undefined ||
    ...
    return (attributes.borderTopRightRadius !== undefined ||
...
const BorderRadiusControl = (props: BorderRadiusControlProps) => {
    ...
    const isMixed = calculateIsMixed(props.attributes, !!props.isResponsive, deviceType);
    ...
    return (
        <div className="wpx--border-radius-control">
            <ControlHeader
                title={ props.label }
            ...
            {props.isResponsive ?
                <BorderRadiusResponsiveControl
                    ...
                    setAttributes={attributes => props.setAttributes(attributes as CSSProperties)}
                    isLinked={isLinked}
