...
const OPTIONS = [
    ...
    {key: 'none', name: 'None'},
    {key: 'disc', name: 'Disc', className: 'wpx--disk'},
    {key: 'circle', name: 'Circle', className: 'wpx--circle'},
    {key: 'square', name: 'Square', className: 'wpx--square'},
];
...
const ListStyleTypeControl = (props: ListStyleTypeControlProps) => {
    ...
    return (
        <div className="wpx--list-style-type-control">
            <CustomSelectControl
                label={ props.label }
                options={ OPTIONS }
                onChange={ ({selectedItem}: { selectedItem: ListStyleTypeOption }) => onChange(selectedItem) }
