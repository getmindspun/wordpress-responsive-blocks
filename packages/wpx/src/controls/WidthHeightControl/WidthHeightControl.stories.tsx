...
import WidthHeightControl, {WidthHeightProperties} from './WidthHeightControl';
...
export const Default: Story = {
    render: () => {
        const [attributes, setAttributes] = useState<WidthHeightProperties>({} as WidthHeightProperties);
        return (
