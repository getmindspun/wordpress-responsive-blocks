...
const BlockAlignResponsiveControl = (props: BlockAlignControlProps) => {
    ...
    const options = props.options ? props.options : ['left', 'center', 'right', 'wide', 'full'] as BlockAlign[];
            ...
            {deviceType === 'Tablet' &&
                <BlockAlignBaseControl
                    ...
                    onChange={tabletBlockAlign => {
                        props.setAttributes({...props.attributes, tabletBlockAlign});
                    }}
                    options={options}
                />
            }
            {deviceType === 'Mobile' &&
                <BlockAlignBaseControl
                    ...
                    onChange={mobileBlockAlign => {
                        props.setAttributes({...props.attributes, mobileBlockAlign});
                    }}
                    options={options}
                />
            }
