...
const JustifyContentResponsiveControl = (props: JustifyContentControlProps) => {
    ...
    const options = props.options ? props.options : ['left', 'center', 'right', 'wide', 'full'] as JustifyContent[];
            ...
            {deviceType === 'Tablet' &&
                <JustifyContentBaseControl
                    ...
                    onChange={tabletJustifyContent => {
                        props.setAttributes({...props.attributes, tabletJustifyContent});
                    }}
                    options={options}
                />
            }
            {deviceType === 'Mobile' &&
                <JustifyContentBaseControl
                    ...
                    onChange={mobileJustifyContent => {
                        props.setAttributes({...props.attributes, mobileJustifyContent});
                    }}
                    options={options}
                />
            }
