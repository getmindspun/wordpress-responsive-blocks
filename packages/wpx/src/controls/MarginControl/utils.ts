...
function calculateIsMixed(attributes: BlockCSSProperties, deviceType: string) {
	switch (deviceType) {
		case 'Tablet':
			return (
				attributes.tabletMarginTop !== attributes.tabletMarginBottom ||
				attributes.tabletMarginTop !== attributes.tabletMarginLeft ||
				attributes.tabletMarginTop !== attributes.tabletMarginRight
			);
		case 'Mobile':
			return (
				attributes.mobileMarginTop !== attributes.mobileMarginBottom ||
...
export function areAllMarginsEqual(attributes: CSSProperties) {
	return (
		attributes.marginTop === attributes.marginBottom &&
...
export function showClear(attributes: BlockCSSProperties, deviceType: string) {
	switch (deviceType) {
		case 'Tablet':
			return (
				attributes.tabletMarginTop !== undefined ||
		...
		case 'Mobile':
			return (
				attributes.mobileMarginTop !== undefined ||
	...
	return (
		attributes.marginTop !== undefined ||
