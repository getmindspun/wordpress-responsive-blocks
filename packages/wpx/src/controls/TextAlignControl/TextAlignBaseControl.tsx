    ...
    return (
        <ButtonGroup>
            <Button
                ...
                onClick={() => {
                    const textAlign = props.textAlign !== 'left' ? 'left' : undefined;
            ...
            <Button
                ...
                onClick={() => {
                    const textAlign = props.textAlign !== 'center' ? 'center' : undefined;
                    props.onChange(textAlign);
                }}
            />
            <Button
                ...
                onClick={() => {
                    const textAlign = props.textAlign !== 'right' ? 'right' : undefined;
                    props.onChange(textAlign);
                }}
            />
        </ButtonGroup>
