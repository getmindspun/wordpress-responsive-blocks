...
const CustomCSSEditor = (
	...
	const selector = `#mrblx-${props.blockId}, *[data-mrblx-id="${props.blockId}"]`;
	...
	return (
		<div>
			...
			<DeviceTypeContainer deviceType={'Desktop'}>
				<small>
					{__(
						'CSS added here should be scoped to the block, meaning each selector should begin with '
					)}
					<em>{selector}.</em>
				</small>
			</DeviceTypeContainer>
			<DeviceTypeContainer deviceType={'Tablet'}>
				<small>
					{__(
						'This CSS will automatically be wrapped in a media query to limit it to tablet devices and smaller.'
					)}
				</small>
			</DeviceTypeContainer>
			<DeviceTypeContainer deviceType={'Mobile'}>
				<small>
					{__(
						'This CSS will automatically be wrapped in a media query to limit it to mobile devices.'
					)}
				</small>
			</DeviceTypeContainer>
		</div>
