...
function validateRequired(input: HTMLInputElement, validation: Validation): string|null {
...
function validateText(input: HTMLInputElement, validation: Validation): string|null {
    ...
    if (validation.minLength) {
        if (!input.value || input.value.length < validation.minLength) {
            return __('Please enter at least %d characters'.replace('%d', validation.minLength.toString()))
        }
    }
    return null;
}
...
export function validate(input: HTMLInputElement, validation: Validation): string|null {
