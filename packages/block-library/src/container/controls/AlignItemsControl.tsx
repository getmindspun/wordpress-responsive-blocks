...
type AlignItemsProperties = Pick<BlockCSSProperties, 'alignItems'|'tabletAlignItems'|'mobileAlignItems'>;
...
function alignItemsValue(direction: string|undefined){
    return direction !== 'default' ? direction as AlignItemsProperties['alignItems'] : undefined;
}
