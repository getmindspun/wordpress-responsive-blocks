...
export function showClear(style: OverflowProperties, deviceType: string) {
	switch (deviceType) {
		case 'Tablet':
			return (
				style.tabletOverflowX !== undefined ||
				style.tabletOverflowY !== undefined
			);
		case 'Mobile':
			return (
				style.mobileOverflowX !== undefined ||
				style.mobileOverflowY !== undefined
			);
	}
...
function overflowXValue(value: string) {
	return value !== 'default'
		? (value as CSSProperties['overflowX'])
		: undefined;
}

function overflowYValue(value: string) {
	return value !== 'default'
		? (value as CSSProperties['overflowY'])
		: undefined;
}
		...
		<div className={'wpx--overflow-control'}>
			...
			<DeviceTypeContainer deviceType={'Desktop'}>
				<SelectControl
					...
					onChange={(overflowX) =>
						props.setAttributes({
							overflowX: overflowXValue(overflowX),
						})
					}
				...
				<SelectControl
					...
					onChange={(overflowY) =>
						props.setAttributes({
							overflowY: overflowYValue(overflowY),
						})
					}
					__nextHasNoMarginBottom
				/>
			...
			<DeviceTypeContainer deviceType={'Tablet'}>
				<SelectControl
					...
					options={OPTIONS}
					onChange={(tabletOverflowX) =>
						props.setAttributes({
							tabletOverflowX: overflowXValue(tabletOverflowX),
						})
					}
					__nextHasNoMarginBottom
				/>
				<SelectControl
					...
					options={OPTIONS}
					onChange={(tabletOverflowY) =>
						props.setAttributes({
							tabletOverflowY: overflowYValue(tabletOverflowY),
						})
					}
					__nextHasNoMarginBottom
				/>
			...
			<DeviceTypeContainer deviceType={'Mobile'}>
				<SelectControl
					...
					options={OPTIONS}
					onChange={(mobileOverflowX) =>
						props.setAttributes({
							mobileOverflowX: overflowXValue(mobileOverflowX),
						})
					}
					__nextHasNoMarginBottom
				/>
				<SelectControl
					...
					options={OPTIONS}
					onChange={(mobileOverflowY) =>
						props.setAttributes({
							mobileOverflowY: overflowYValue(mobileOverflowY),
						})
					}
					__nextHasNoMarginBottom
				/>
