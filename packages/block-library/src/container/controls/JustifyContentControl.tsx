...
type JustifyContentProperties = Pick<
	BlockCSSProperties,
	'justifyContent' | 'tabletJustifyContent' | 'mobileJustifyContent'
>;
...
function justifyContentValue(direction: string | undefined) {
	return direction !== 'default'
		? (direction as JustifyContentProperties['justifyContent'])
		: undefined;
}
	...
	return (
		<div className={'mrblx--justify-content-control'}>
			...
			<DeviceTypeContainer deviceType={'Desktop'}>
				<SelectControl
					...
					onChange={(justifyContent) =>
						props.setAttributes({
							justifyContent: justifyContentValue(justifyContent),
						})
					}
			...
			<DeviceTypeContainer deviceType={'Tablet'}>
				<SelectControl
					value={
						props.attributes.tabletJustifyContent
							? props.attributes.tabletJustifyContent
							: 'default'
					}
					options={OPTIONS}
					onChange={(tabletJustifyContent) =>
						props.setAttributes({
							tabletJustifyContent:
								justifyContentValue(tabletJustifyContent),
						})
					}
					__nextHasNoMarginBottom
				/>
			...
			<DeviceTypeContainer deviceType={'Mobile'}>
				<SelectControl
					value={
						props.attributes.mobileJustifyContent
							? props.attributes.mobileJustifyContent
							: 'default'
					}
					options={OPTIONS}
					onChange={(mobileJustifyContent) =>
						props.setAttributes({
							mobileJustifyContent:
								justifyContentValue(mobileJustifyContent),
						})
					}
					__nextHasNoMarginBottom
				/>
