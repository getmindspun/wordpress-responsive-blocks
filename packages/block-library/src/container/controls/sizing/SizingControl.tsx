...
export function showClear(style: FlexSizingProperties, deviceType: string) {
	switch (deviceType) {
		case 'Tablet':
			return (
				style.tabletFlexGrow !== undefined ||
				style.tabletFlexShrink ||
				style.tabletFlexBasis
			);
		case 'Mobile':
			return (
				style.mobileFlexGrow !== undefined ||
				style.mobileFlexShrink ||
				style.mobileFlexBasis
			);
	}
	return (
		...
		<div className={'mrblx--flex-sizing-control'}>
			...
			<DeviceTypeContainer deviceType={'Desktop'}>
				<SelectControl
					...
					options={OPTIONS}
					onChange={(value) =>
						props.setAttributes(fromValue(value, 'Desktop'))
					}
			...
			<DeviceTypeContainer deviceType={'Tablet'}>
				<SelectControl
					...
					options={OPTIONS}
					onChange={(value) =>
						props.setAttributes(fromValue(value, 'Tablet'))
					}
					__nextHasNoMarginBottom
				/>
			</DeviceTypeContainer>
			<DeviceTypeContainer deviceType={'Mobile'}>
				<SelectControl
					...
					options={OPTIONS}
					onChange={(value) =>
						props.setAttributes(fromValue(value, 'Mobile'))
					}
					__nextHasNoMarginBottom
				/>
			</DeviceTypeContainer>
