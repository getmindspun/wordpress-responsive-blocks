    ...
    return (
        <>
            <NumberControl
                ...
                onChange={colspan => {
                    const tagAttrs = {...props.attributes.tagAttrs, colspan: colspan ? parseInt(colspan) : undefined}
            ...
            <NumberControl
                ...
                onChange={rowspan => {
                    const tagAttrs = {...props.attributes.tagAttrs, rowspan: rowspan ? parseInt(rowspan) : undefined}
                    props.setAttributes({tagAttrs});
                }}
                min={1}
            />
