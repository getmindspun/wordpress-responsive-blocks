...
export default function Edit(props: Props) {
    ...
    useEffect(() => {
        if (window.mrblxData?.rest_url && props.attributes.action === null && props.attributes.encType === null) {
            const action = `${window.mrblxData.rest_url}/form`;
            props.setAttributes({action, encType: 'application/json', method: 'POST'});
        }
    }, [])
